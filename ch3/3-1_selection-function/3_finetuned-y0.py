...
if __name__ == "__main__":
    print("[Figure 3.4, page 32]")
    print('''
    This is to experimentally validate that the correlation traces when
    using the fine-tuned y_0^j (tilde) as the selection function has many 
    ghost peaks, because of the activities on the nonce.
    Check the two figures `ftyk0_0.png` and `ftyk0_1.png` in the folder `output`.
    ''')
    ...
    plt.plot(r0)
    plt.savefig("outputs/ftyk0_0.png")
    ...
    plt.plot(r1)
    plt.savefig("outputs/ftyk0_1.png")
